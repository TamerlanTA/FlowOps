        ...
        <div className="relative">
          <div className="absolute left-0 right-0 top-[52px] hidden h-[2px] lg:block">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(0,212,192,0.18), rgba(139,92,246,0.15), rgba(0,212,192,0.18), transparent)",
              }}
            />
          </div>
          ...
          <div className="absolute bottom-0 left-[35px] top-0 w-[2px] lg:hidden sm:left-[43px]">
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent, rgba(0,212,192,0.1), rgba(139,92,246,0.12), rgba(0,212,192,0.1), transparent)",
              }}
            />
          </div>
              ...
              <Reveal key={step.title} variant="up" index={index} staggerBase={120}>
                <div className="group relative flex gap-5 lg:flex-col lg:gap-0 lg:text-center">
                  <div className="relative flex size-[72px] shrink-0 items-center justify-center sm:size-[88px] lg:mx-auto lg:mb-6 lg:size-[104px]">
                    <div className="absolute inset-0 rounded-full liquid-glass prismatic-edge transition-all duration-500 md:group-hover:-translate-y-1 md:group-hover:shadow-[0_8px_30px_rgba(0,212,192,0.1)]" />
                    <div className="relative flex size-10 items-center justify-center rounded-full text-[#00d4c0] transition-transform duration-500 liquid-glass-subtle sm:size-12 lg:size-14 md:group-hover:scale-110">
                      <step.icon className="size-4 sm:size-5" />
                    </div>
                  </div>

                  <div className="flex flex-col justify-center lg:items-center">
                    <span className="mb-1 block text-[10px] font-semibold uppercase tracking-widest text-[rgba(0,212,192,0.7)] sm:text-xs lg:mb-2">
                      Step {step.number}
                    </span>
