          ...
          <div className="rounded-2xl p-8 text-center liquid-glass-elevated prismatic-edge sm:rounded-[2rem] sm:p-12 md:p-16">
            ...
            <div className="relative">
              ...
              <div className="mt-8 sm:mt-10">
                <Link
                  href="/#contact"
                  className="inline-flex w-full items-center justify-center rounded-xl bg-blue-500 px-8 py-3 text-base font-medium text-white shadow-xl shadow-blue-500/20 transition-all duration-300 hover:bg-blue-400 active:scale-[0.98] sm:w-auto sm:rounded-2xl sm:px-10 sm:py-4 md:hover:scale-[1.03]"
                >
                  Request Free Audit
                  <svg
                    className="ml-2"
