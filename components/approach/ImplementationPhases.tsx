          ...
          <div className="absolute bottom-0 left-6 top-0 w-px md:left-1/2 md:-translate-x-1/2">
            <Reveal variant="fade" delay={100}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, transparent, rgba(0,212,192,0.18) 5%, rgba(0,212,192,0.18) 95%, transparent)",
                }}
              />
            </Reveal>
          </div>
              ...
              <Reveal key={phase.title} variant="up" index={index} staggerBase={120}>
                <div className="relative flex gap-8 md:items-center">
                  ...
                  <div className="relative z-10 flex shrink-0 items-center justify-center">
                    <div className="flex size-12 items-center justify-center rounded-full border border-[rgba(0,212,192,0.2)] text-[#00d4c0] shadow-[0_0_20px_rgba(0,212,192,0.1)] liquid-glass-elevated">
