        ...
        <Reveal variant="scale" delay={250}>
          <div className="rounded-3xl p-8 liquid-glass-elevated prismatic-edge md:p-12">
                ...
                {nodes.map((node, index) => (
                  <div key={node.label} className="flex flex-1 items-center gap-2 last:flex-initial">
                    <div className="group flex flex-1 flex-col items-center gap-3">
                      <div className="flex size-16 items-center justify-center rounded-2xl border border-[rgba(0,212,192,0.1)] transition-all duration-500 liquid-glass-subtle md:group-hover:scale-110 md:group-hover:shadow-[0_0_24px_rgba(0,212,192,0.1)]">
                        <node.icon className="size-6 text-[#00d4c0]" />
                      </div>
                    ...
                    {index < nodes.length - 1 ? (
                      <div className="-mt-6 flex items-center px-1">
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(90deg, rgba(0,212,192,0.25), rgba(0,212,192,0.08))",
                          }}
                        />
                        <svg
                          width="8"
                          ...
                          viewBox="0 0 8 10"
                          fill="none"
                          className="shrink-0 text-[rgba(0,212,192,0.4)]"
                        >
                          <path
                            d="M1 1L6 5L1 9"
                            stroke="currentColor"
            ...
            <div className="flex flex-col gap-4 md:hidden">
              {nodes.map((node, index) => (
                <div key={node.label}>
                  <div className="group flex items-center gap-4 rounded-2xl p-4 transition-all duration-500 liquid-glass-subtle md:hover:shadow-[0_0_20px_rgba(0,212,192,0.08)]">
                    <div className="flex size-12 shrink-0 items-center justify-center rounded-xl text-[#00d4c0] transition-transform duration-500 liquid-glass-subtle md:group-hover:scale-110">
                  ...
                  {index < nodes.length - 1 ? (
                    <div className="ml-10 flex justify-center py-1">
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to bottom, rgba(0,212,192,0.25), rgba(0,212,192,0.08))",
                        }}
                      />
                    </div>
                  ) : null}
