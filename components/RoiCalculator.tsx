  ...
  return (
    <div className="space-y-2.5 sm:space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="shrink-0 text-xs font-semibold tabular-nums text-[#00d4c0] sm:text-sm">
      ...
      >
        {highlighted ? (
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 30%, rgba(0,212,192,0.06), transparent 70%)",
            }}
          />
        ) : null}
        ...
        <div
          className={`relative mb-3 flex size-9 items-center justify-center rounded-lg sm:mb-4 sm:size-11 sm:rounded-xl ${
            highlighted
              ? "bg-[rgba(0,212,192,0.1)] text-[#00d4c0]"
        ...
        <p
          className={`text-lg font-bold tabular-nums sm:text-2xl md:text-3xl ${
            highlighted ? "text-[#00d4c0]" : "text-white"
          }`}
        >
            ...
            <Reveal delay={600}>
              <div className="mt-4 rounded-2xl p-6 text-center liquid-glass-elevated prismatic-edge sm:mt-8 sm:rounded-3xl sm:p-8">
                ...
                <div className="mt-4 sm:mt-6">
                  <Link
                    href="/#contact"
                    className="inline-flex w-full items-center justify-center rounded-xl btn-primary px-8 py-3 text-sm font-bold text-white transition-all duration-300 active:scale-[0.98] sm:w-auto sm:rounded-2xl md:hover:scale-[1.03]"
                  >
